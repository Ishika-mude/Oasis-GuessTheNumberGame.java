...
class Game{
    ...
    public boolean takeUserInput() {
        ...
        {
         System.out.print("Number of attempts finist...Better luck next time\n");
         return true;
        }
    }
    ...
    public boolean isCorrectGuess(){
        ...
        {
         System.out.print("Congratulations!!! You guess the number" + systemInput + "in" + noOfGuesses + "guesses");
         switch(noOfGuesses){
             case 1:
